      ...
      <div className="container">
        ...
        <div className="flex flex-col mt-10 gap-20 md:mt-20">
          {portfolioProjects.map((project) => (
            <div
              key={project.title}
              className="bg-gray-800 md:pt-12 md-px-10 lg:pt-16 lg:px-20 z-0 overflow-hidden rounded-3xl relative after:content-[''] after:absolute after:pointer-events-none after:inset-0 after:z-10 after:outline-2 after:outline-offset-2 after:outline after:rounded-3xl after:outline-white/20 px-8 pt-8"
            >
              <div
